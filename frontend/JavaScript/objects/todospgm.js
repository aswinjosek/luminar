...
// for(let todo of todos){
//     if(!(todo.userId in todocount_user)){
//         todocount_user[todo.userId]=1;
//     }
//     else{
//         todocount_user[todo.userId]+=1;
//     }
...
//   todos.map(todo=>todo.userId in todocount_user?todocount_user[todo.userId]+=1:todocount_user[todo.userId]=1);
//   console.log(todocount_user);
...
// { 1:{user_id:1,completed:10,not_completed:10,total:20},
//   2:{user_id:2,completed:10,not_completed:10,total:20}
...
for (let todo of todos) {
  ...
  if (!(user_Id in user_details)) {
    ...
    if (todo.completed == true) {
      user_details[user_Id]["completed"]+1;
    
    } else {
      user_details[user_Id]["not completed"]+1;
      
    }
    user_details[user_Id]["total"]+1;
